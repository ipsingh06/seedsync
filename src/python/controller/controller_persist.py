...
class ControllerPersist(Persist):
    ...
    def from_str(cls: "ControllerPersist", content: str) -> "ControllerPersist":
        ...
        persist.downloaded_file_names = dct[ControllerPersist.__KEY_DOWNLOADED_FILE_NAMES]
        return persist

    @overrides(Persist)
    def to_str(self) -> str:
        dct = dict()
        dct[ControllerPersist.__KEY_DOWNLOADED_FILE_NAMES] = self.downloaded_file_names
